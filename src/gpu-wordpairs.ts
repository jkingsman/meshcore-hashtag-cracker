...
export class GpuWordPairs {
  ...
  private matchIBuffer: GPUBuffer | null = null;        // i indices for matches
  private matchJBuffer: GPUBuffer | null = null;        // j indices for matches
  private ciphertextBuffer: GPUBuffer | null = null;
  private wordDataBuffer: GPUBuffer | null = null;      // Packed word bytes
  private wordOffsetsBuffer: GPUBuffer | null = null;   // (offset, length) for each word

  // Staging buffers
  private matchCountReadBuffer: GPUBuffer | null = null;
  private matchIReadBuffer: GPUBuffer | null = null;
  private matchJReadBuffer: GPUBuffer | null = null;
